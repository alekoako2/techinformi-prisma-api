...
async function createTechnologyTransferNetworkSchema(input, ctx: Context) {
  let schema: TechnologyTransferNetworkCreateInput = <TechnologyTransferNetworkCreateInput>{};
...
async function updateTechnologyTransferNetworkSchema(input, id, ctx: Context) {
  ...
  let schema: TechnologyTransferNetworkUpdateInput = <TechnologyTransferNetworkUpdateInput>{};
...
export const technologyTransferNetwork = {
  ...
  async updateTechnologyTransferNetwork(parent, args, ctx: Context) {
    ...
    const technologyTransferNetwork = await ctx.prisma.technologyTransferNetwork({ id });
